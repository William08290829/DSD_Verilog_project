...
HD_PWD='C:/Users/leeea/final_project/final_project.runs/buckethead_zombie_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log buckethead_zombie.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source buckethead_zombie.tcl
