...
HD_PWD='C:/Users/leeea/final_project/final_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGAExample.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGAExample.tcl
