...
HD_PWD='C:/Users/leeea/final_project/final_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VGAExample.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VGAExample.tcl -notrace
