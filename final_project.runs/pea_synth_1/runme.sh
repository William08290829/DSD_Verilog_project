...
HD_PWD='C:/Users/leeea/final_project/final_project.runs/pea_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pea.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pea.tcl
