...
HD_PWD='C:/Users/leeea/final_project/final_project.runs/wall_nut_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wall_nut.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wall_nut.tcl
