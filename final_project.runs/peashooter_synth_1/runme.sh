...
HD_PWD='C:/Users/leeea/final_project/final_project.runs/peashooter_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log peashooter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source peashooter.tcl
