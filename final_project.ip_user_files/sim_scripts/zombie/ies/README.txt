...
#
# Generated by export_simulation on Thu Jun 15 12:03:40 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './zombie.sh' script.
...
./zombie.sh -noclean_files

For more information on the script, please type './zombie.sh -help'.
