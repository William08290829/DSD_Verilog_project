...
#
# Generated by export_simulation on Fri Jun 02 14:57:16 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './peashooter_big.sh' script.

./peashooter_big.sh -reset_run
...
./peashooter_big.sh -noclean_files

For more information on the script, please type './peashooter_big.sh -help'.
