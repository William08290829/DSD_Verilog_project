...
#
# Generated by export_simulation on Fri Jun 02 17:46:25 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './wall_nut_big.sh' script.

./wall_nut_big.sh -reset_run
...
./wall_nut_big.sh -noclean_files

For more information on the script, please type './wall_nut_big.sh -help'.
