...
#
# Generated by export_simulation on Fri Jun 16 00:05:04 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './pea.sh' script.
...
./pea.sh -noclean_files

For more information on the script, please type './pea.sh -help'.
