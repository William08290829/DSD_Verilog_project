...
#
# Generated by export_simulation on Sun Jun 04 11:43:45 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './wall_nut.sh' script.

./wall_nut.sh -reset_run
...
./wall_nut.sh -noclean_files

For more information on the script, please type './wall_nut.sh -help'.
