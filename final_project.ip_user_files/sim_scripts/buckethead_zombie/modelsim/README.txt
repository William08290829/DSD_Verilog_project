...
#
# Generated by export_simulation on Fri Jun 09 13:49:00 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './buckethead_zombie.sh' script.

./buckethead_zombie.sh -reset_run
...
./buckethead_zombie.sh -noclean_files

For more information on the script, please type './buckethead_zombie.sh -help'.
