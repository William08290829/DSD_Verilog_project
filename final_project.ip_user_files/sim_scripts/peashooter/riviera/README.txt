...
#
# Generated by export_simulation on Sun Jun 04 11:43:00 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './peashooter.sh' script.

./peashooter.sh -reset_run
...
./peashooter.sh -noclean_files

For more information on the script, please type './peashooter.sh -help'.
